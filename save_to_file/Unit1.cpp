...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
        ...
        plik.open("C:\\Users\\wojte\\Documents\\programowanie borland builder\\czas.txt", ios::in);
        if(plik.good()==false)Application->MessageBox(
        "Remember to keep file czas.txt in right directory",
...
void __fastcall TForm1::Timer2Timer(TObject *Sender)
{
       ...
       //AnsiString sciezka_do_pliku = ExtractFilePath(Application->ExeName) + "czas2.txt";
       //const char* sciezka=sciezka_do_pliku.c_str();
       plik.open("C:\\Users\\wojte\\Documents\\programowanie borland builder\\czas.txt", ios::out | ios::app);
       plik<<1<<endl;
       plik.close();
}
//---------------------------------------------------------------------------
