...
void __fastcall TForm1::Otwrz1Click(TObject *Sender)
{
        if(OpenDialog1->Execute())
        {
                ...
                {
                ShowMessage("B³ad otwarcia pliku. Upewnij siê, czy plik istnieje na dysku.");
                }
        }
}
//---------------------------------------------------------------------------
    ...
    if(SaveDialog1->Execute())
        {
                ...
                {
                ShowMessage("Próba zapisu nie udana.");
                }
        }
}
//---------------------------------------------------------------------------
...
{
        if(Application->MessageBox("Czy na pewno utworzyæ nowy plik?",
...
void __fastcall TForm1::ZA1Click(TObject *Sender)
{
...
void __fastcall TForm1::Kopu1Click(TObject *Sender)
{
...
void __fastcall TForm1::Informacjenablogu1Click(TObject *Sender)
{
        ShellExecute(NULL, "open", "http://pulawy.infometeo.pl/", NULL, NULL,
        SW_SHOWNORMAL);
}
//---------------------------------------------------------------------------
